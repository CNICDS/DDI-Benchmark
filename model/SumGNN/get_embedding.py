...
def save_test_embeddings(evaluator, save_path):
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            emb = evaluator.graph_classifier.get_pair_embedding(data_pos)
    ...
    np.save(os.path.join(save_path, "test_embeddings.npy"), final_emb)
    np.save(os.path.join(save_path, "test_labels.npy"), np.array(all_labels))
