...
def main(params):
    ...
    params.db_path = os.path.join(params.main_dir, f'upload/data/SumGNN/{params.dataset}/S0/subgraphs_en_{params.enclosing_sub_graph}_neg_{params.num_neg_samples_per_link}_hop_{params.hop}')
