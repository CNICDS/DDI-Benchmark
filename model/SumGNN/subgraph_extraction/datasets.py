...
def generate_subgraph_datasets(params, splits=['train', 'valid', 'test'], saved_relation2id=None, max_label_value=None):
    ...
    triple_file = 'upload/data/SumGNN/{}/S0/relations_2hop.txt'.format(params.dataset)
    ...
    data_path = os.path.join(params.main_dir, f'upload/data/SumGNN/{params.dataset}/S0/relation2id.json')
    ...
    #print(graphs.keys())
    if testing:
        directory = os.path.join(params.main_dir, 'upload/data/SumGNN/{}/S0/'.format(params.dataset))
...
class SubgraphDataset(Dataset):
    ...
    def __init__(self, db_path, db_name_pos, db_name_neg, raw_data_paths, included_relations=None, add_traspose_rels=False, num_neg_samples_per_link=1, use_kge_embeddings=False, dataset='', kge_model='', file_name='', \
        ...
        triple_file = 'upload/data/SumGNN/{}/S0/relations_2hop.txt'.format(dataset)
        self.entity_type = np.loadtxt('upload/data/SumGNN/{}/S0/entity.txt'.format(dataset))
        ...
        if not ssp_graph:
            ...
            data_path =  'upload/data/SumGNN/{}/S0/relation2id.json'.format(dataset)
            #print(os.pwd)
