...
def get_embeddings(loader_test, model, save_path_prefix='test_emb'):
    model.eval()
    all_embs = []
    all_labels = []
    ...
    np.save(f'{save_path_prefix}_embeddings_0.npy', all_embs)
    np.save(f'{save_path_prefix}_labels_0.npy', all_labels)

    print(f'Saved embeddings to {save_path_prefix}_embeddings_0.npy')
    print(f'Saved labels to {save_path_prefix}_labels_0.npy')
...
if __name__=='__main__':
    ...
    test_csv = './MCFF-MTDDI-main/Multi-Class-data1/test_s0.csv'
    ...
    get_embeddings(loader_test, model, save_path_prefix='dbn')