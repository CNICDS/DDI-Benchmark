...
print(args)
############################################################
df_ddi_train = pd.read_csv('./data/twosides/virtual/train_s2.csv')
# df_ddi_val = pd.read_csv('./data/twosides/valid_s2.csv')
df_ddi_test = pd.read_csv('./data/twosides/virtual/test_s2.csv')
...
extract_embeddings(test_model, test_data_loader,
                     save_path_emb='saved_embeddings/tw_nodeembeddings_2.npy',device=device)
