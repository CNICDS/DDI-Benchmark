...
class RESCAL(nn.Module):
    def __init__(self, n_rels, n_features):
        ...
        self.n_rels = n_rels
        self.n_features = n_features
        # max_rels_index = rels.max().item() + 1  # Add 1 to account for zero-based indexing
        # self.n_rels = max(self.n_rels, max_rels_index) 
        #self.rel_emb = nn.Embedding(200, embedding_dim)  # Increase num_embeddings to 200
        self.n_rels = max(self.n_rels, 200)
    ...
    def forward(self, heads, tails, rels, alpha_scores):
        ...
        #rels = rels % 86  # Wrap indices to the valid range
