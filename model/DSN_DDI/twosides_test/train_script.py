...
parser.add_argument('--pkl_name', type=str, default='s0_226_tw.pkl')
parser.add_argument('--result_name', type=str, default='./model/DSN_DDI/twosides_test/result/s0_226_tw.txt')
...
device = 'cuda:5' if torch.cuda.is_available() and args.use_cuda else 'cpu'

print(args)
############################################################

df_ddi_train = pd.read_csv('./data/twosides/train_s0.csv')
df_ddi_val = pd.read_csv('./data/twosides/valid_s0.csv')
