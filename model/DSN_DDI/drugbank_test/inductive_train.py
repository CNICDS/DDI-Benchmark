...
parser.add_argument('--pkl_name', type=str, default='s1s2_226_db.pkl')
parser.add_argument('--result_name', type=str, default='./model/DSN_DDI/drugbank_test/result/s1s2_226_db.txt')
...
###### Dataset
df_ddi_train = pd.read_csv('./data/Drugbank/train_s1.csv')
df_ddi_s1 = pd.read_csv('./data/Drugbank/test_s1.csv')
df_ddi_s2 = pd.read_csv('./data/Drugbank/test_s2.csv')
