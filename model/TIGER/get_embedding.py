...
def init_args(user_args=None):
    ...
    parser.add_argument('--dataset', type=str, default="drugbank_new2")  # drugbank_new0, drugbank_new1, drugbank_new2, drugbank_new3, twosides, twosides_1, twosides_2
...
def extract_embeddings(model, test_loader, device, save_emb='embeddings.npy', save_lab='labels.npy'):
    model.eval()
    embedding_list = []
    label_list = []
...
def main(args=None):
    ...
    extract_embeddings(model, test_loader, device,
                  save_emb='dbn_embeddings_2.npy',
                  save_lab='dbn_labels_2.npy')
