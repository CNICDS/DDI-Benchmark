...
def extract_embeddings(model, test_loader, save_path_emb, device='cuda:0'):
    model.eval()
    all_embeddings = []
    all_labels = []
...
extract_embeddings(
    model,
    s1_data_loader,
    save_path_emb='saved_embeddings/tw_nodeembeddings_1.npy',
    device=device  # 你之前设置的 device='cuda:6'
)
extract_embeddings(
    model,
    s2_data_loader,
    save_path_emb='saved_embeddings/tw_nodeembeddings_2.npy',
    device=device  # 你之前设置的 device='cuda:6'
)