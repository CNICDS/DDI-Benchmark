...
def evaluate(args, model, tokenizer, desc_tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        confuse_matrix_file = os.path.join(eval_output_dir, prefix, "confusion_matrix.csv")
        pd.DataFrame(results["confusion_matrix"]).to_csv(confuse_matrix_file, index=False)
