...
def process_dataset(params):
    ...
    params.aug_num_rels = train_data.aug_num_rels  # including relations in BKG and evaluator loop
...
def main(params):
    ...
    # test_results, test_outputs = test_evaluator.eval()

    test_cm = test_evaluator.get_cm(save_path=os.path.join(params.main_dir, 'test_confusion_matrix.pkl'))
