...
smiles_list = df_drugs_smiles['smiles'].tolist()

valid, invalid = filter_valid_smiles(smiles_list)

# 筛选出合法的数据
df_drugs_smiles = df_drugs_smiles[df_drugs_smiles['smiles'].isin(valid)].reset_index(drop=True)
